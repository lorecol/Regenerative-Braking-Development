...
FileName = '40degC/03-01-19_19.23 705_HPPC_40degC_IN21700_30T.mat';
...
save battery40C.mat time voltage current;

clear FileName meas voltage time current;

% Read the raw data
[time,voltage,current] = Battery.loadDataFromMatFile('battery40C.mat');
